...
exports.ai = void 0;
exports.generateQuizFromLlm = generateQuizFromLlm;
const genai_1 = require("@google/genai");
const env_1 = require("../constants/env");
const prompts_1 = require("./prompts");
exports.ai = new genai_1.GoogleGenAI({ apiKey: env_1.geminiApiKey });
//QUIZZES
async function generateQuizFromLlm(content) {
    try {
        const httpResponse = await fetch("https://openrouter.ai/api/v1/chat/completions", {
            ...
            body: JSON.stringify({
                ...
                messages: [
                    {
                        role: "user",
                        content: (0, prompts_1.quizPrompt)(content)
                    }
                ],
            }),
        });
        ...
        console.error("🔴 Error generating quiz at ./utils/llm.ts -> generateQuizWithLLM()", error);
        throw error;
    }
}
