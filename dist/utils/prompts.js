...
exports.quizPrompt = quizPrompt;
exports.clearUpPrompt = clearUpPrompt;
function quizPrompt({ subject, qTypes, difficulty, number, prev }) {
    return `
...
//CLEAR UPS 
function clearUpPrompt({ subject, qTypes, prev }) {
    return `
